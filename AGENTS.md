...
### Hard Constraints
- **NO PHANTOM COMPLETIONS:** Never say done if git commit not executed
- **NO SILENT FAILURES:** Report exact errors, ask for intervention
- **NO STACK ASSUMPTIONS:** Verify language version, framework, package manager before running commands
- **QA IS GOD:** DoD is binding contract
